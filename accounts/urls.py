...
urlpatterns = [
    ...
    path("users/<int:pk>/approve-registration/", views.user_registration_approve, name="user_registration_approve"),
    path("users/<int:pk>/reject-registration/", views.user_registration_reject, name="user_registration_reject"),
