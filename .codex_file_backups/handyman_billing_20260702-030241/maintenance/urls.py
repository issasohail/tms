...
urlpatterns = [
    ...
    path("categories/<int:pk>/requests/", views.category_request_list, name="category_requests"),
    path("categories/<int:pk>/update/", views.category_update, name="category_update"),
    path("categories/<int:pk>/delete/", views.category_delete, name="category_delete"),
    path("public/request/<str:token>/", views.public_request_create, name="public_request_create"),
    path("public/confirmation/<str:token>/", views.public_request_confirmation, name="public_request_confirmation"),
    path("public/confirmation/<str:token>/download/", views.public_request_confirmation_download, name="public_request_confirmation_download"),
