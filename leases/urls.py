...
urlpatterns = [
    ...
    path("leases/<int:pk>/family/create-and-add/",
         views.lease_family_create_and_add, name="lease_family_create_and_add"),
    path("leases/<int:pk>/family/public-link/",
         views.lease_family_public_link, name="lease_family_public_link"),
