...
class LeaseCreateView(LoginRequiredMixin, LeaseTenantOrderMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        if debug_sql:
            ...
            proration_result = reconcile_move_in_proration(
                self.object,
                move_in_date=move_in_date,
                enabled=form.cleaned_data.get("create_move_in_proration", False),
                mode=form.cleaned_data.get("move_in_proration_mode") or "exact",
                manual_days=form.cleaned_data.get("move_in_proration_days"),
            )
