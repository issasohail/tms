...
class TenantDetailTable(tables.Table):
    # Serial number column - spans both rows
    sn = tables.Column(
        verbose_name='S.N #',
        empty_values=(),
        orderable=False,
    ...
    class Meta:
        ...
        fields = (
            ...
            'cnic', 'gender', 'cnic_front_thumbnail', 'cnic_back_thumbnail',
            'address', 'notes', 'actions', 'emergency_contact_name',
