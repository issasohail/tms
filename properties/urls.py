...
urlpatterns = [
    ...
    path('<int:property_pk>/bank-accounts/<int:account_pk>/save/', views.property_bank_account_save,
         name='property_bank_account_save'),
    path('<int:property_pk>/bank-accounts/welcome-settings/',
         views.property_bank_account_welcome_settings,
         name='property_bank_account_welcome_settings'),
