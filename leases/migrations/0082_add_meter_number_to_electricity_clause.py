...
CLAUSE_19 = (
    "That the Electricity Meter No. [ELECTRICITY_METER_NUMBER] reading is "
    "[ELECTRICITY_METER_READING] as on [METER_READING_DATE]. "
    "[SMART_METER_ELECTRICITY_TERMS]"
)
...
def update_clause_19(apps, schema_editor):
    ...
    AgreementPlaceholder.objects.update_or_create(
        ...
        defaults={
            ...
            "description": (
                "Uses the active smart-meter number, falling back to the unit's "
                "electricity meter number."
            ),
            "category": "Utilities",
            "source_type": "system",
            "resolver_key": "ELECTRICITY_METER_NUMBER",
            "is_active": True,
            "sort_order": 958,
        },
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("leases", "0081_make_electricity_meter_clause_always_visible"),
    ]
