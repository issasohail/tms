...
from .views import (
    ...
    category_inline_update, category_merge, RecurringChargeListView, RecurringChargeCreateView, RecurringChargeUpdateView, RecurringChargeDeleteView,
...
urlpatterns = [
    ...
    path('iesco-bills/helper-runs/start/', views_iesco_helper.start_fetch_run, name='iesco_helper_run_start'),
    path('iesco-bills/helper-runs/<uuid:pk>/status/', views_iesco_helper.fetch_run_status, name='iesco_helper_run_status'),
    ...
    path('iesco-bills/export/<str:export_format>/', views_iesco.export_formatted, name='iesco_bill_export_formatted'),
    path('iesco-bills/reminders/send/', views_iesco.reminders_send, name='iesco_bill_reminders_send'),
    ...
    path('iesco-bills/readings/<int:pk>/trust/', views_iesco.set_reading_trust, name='iesco_bill_trust'),
    ...
    path('late-fees/run/', views_late_fee.run_late_fee_reminders_now, name='run_late_fee_reminders_now'),
    path('late-fees/invoice/<int:pk>/hold/', views_late_fee.set_invoice_late_fee_hold, name='set_invoice_late_fee_hold'),
    path('late-fees/invoice/<int:pk>/clear-hold/', views_late_fee.clear_invoice_late_fee_hold, name='clear_invoice_late_fee_hold'),
